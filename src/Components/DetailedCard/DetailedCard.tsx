  ...
  return (
    <div className={styles.card}>
      <div className={styles.card__img_block}>
        <div style={{ backgroundImage: `url('${imageURL}')` }} className={hide ? styles.hide : styles.card__image} />
        <div className={styles.card__btns_block}>
            <button type="button" className={styles.card__btn} onClick={showPrev}>Prev</button>
            <button type="button" className={styles.card__btn} onClick={showNext}>Next</button>
        </div>
      </div>
    {data && <div>
        <p>
